...
interface IPrison {
    ...
    function jailedRecords(uint256 index1, uint256 index2)
        external
        view
        returns (address);
    ...
    function missRecords(uint256 index1, uint256 index2)
        external
        view
        returns (address, uint256);

    function addMissRecord(MissRecord[] calldata record)
        external
        returns (address[] memory);

    function unjail(address minerAddress) external payable;

    function getMissRecordsLengthByBlockNumber(uint256 blockNumber)
        external
        view
        returns (uint256);

    function getJaiedMinersLengthByBlockNumber(uint256 blockNumber)
        external
        view
        returns (uint256);
    ...
    function getJailedMinersByIndex(uint256 index)
        external
        view
        returns (address);
